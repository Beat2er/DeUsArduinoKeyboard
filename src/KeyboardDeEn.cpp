/*
  Based on:
  1. https://github.com/MichaelDworkin/Arduino-Leonardo-USB-Keyboard-Deutsch-library
  2. https://github.com/BesoBerlin/Arduino-German-Keyboard
...
PGM_VOID_P _asciimap;
char layout[3];

void Keyboard_layout(char* l) {
  if (strcmp(l, "de") == 0) {
    _asciimap = &de_asciimap;
  } else if (strcmp(l, "en") == 0) {
    _asciimap = &us_asciimap;
  } else {
    return;
  }
  strcpy(layout, l);
